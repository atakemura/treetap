class Rule:
    def __init__(self, idx, rule_str, literals, support, size, accuracy, error_rate, precision, recall, mode_class):
        self.idx = idx
    ...
    def __str__(self):
        return 'rule_idx={}. rule={}. items={}. size={}. mode_class={}.' \
               'accuracy={}. error_rate={}. precision={}. recall={}.'.format(
            self.idx, self.rule_str, self.items, self.size, self.mode_class,
